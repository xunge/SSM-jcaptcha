	    ...
	    if (id == "email") {
	        ...
	        $.ajax({
	            ...
	            success: function(result) {
	                //如果当前的是登录
	                if (result == 1) {
	                	$("#emailinfo .infoerror").text("该邮箱已被注册！！");
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result == false) {
                        ...
                        $("#captchainfo .infoerror").text("验证码错误");
                        $("#captcha").parents(".input-group").addClass("has-error").removeClass("has-success");
                        //$("#captcha").attr("src", "1111");
                        $("#captcha").click(function(){

                        });
                    } else {
                        $("#captchainfo .infoerror").empty();
                        $("#captchainfo .notice").text("验证码正确");
                        $("#captcha").parents(".input-group").addClass("has-success").removeClass("has-error");
                    }
                }
